...
- ~~Nobody has listened to these renders.~~ **A fluent Hindi speaker has now confirmed `guru_line0.wav` says the target sentence** — and this time was told the sentence and asked *"does it say X?"* rather than *"does it sound right?"*. That is the check the wrong-codec audio failed. Still outstanding: the other three voices and lines 1-2.
